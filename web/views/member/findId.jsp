...
<body>
    ...
    <section>
        <form action="<%=request.getContextPath()%>/findIdEnd" method="post">
        	<fieldset>
           	  <legend>회원정보로 아이디 찾기</legend>
              	<ul>
                    ...
                    <li>
                        <label>생년월일</label>
                        <input id="birth" class="inputdata" type="date" name="birth"><br>
                    </li>
                    <li>
                        <label>핸드폰번호</label>
                        <input type="text" id="phone" class="inputdata" name="phone" placeholder="010-0000-0000" maxlength="13">
                    </li>
                </ul>
        </fieldset>
        <br>
