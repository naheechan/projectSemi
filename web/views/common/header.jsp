...
<html>
  ...
  <div id="foottext">
        ...
        <div id="search_container">
          ...
          <%} else{ %>
           <div id="header_nav">
            <ul>
             <li>
              	<p> <%=logginedMember.getMemberId()%>님<p>
              </li>
            <li class="searchbtn"><i class="fas fa-search"></i></li>
              <li>
                <a href="<%=request.getContextPath()%>/myinfomove?userId=<%=logginedMember.getMemberId()%>"><i class="fas fa-user"></i>MyInfo</a>
              </li>
              <li>
    ...
    <form action="" id="searchfrom">
        <div id="input_inbt">
          <input type="text" id="search_input" placeholder="search book"/><input type="submit"
            onclick="test();"
          value="&#xf002"/>
        </div>
      </form>
